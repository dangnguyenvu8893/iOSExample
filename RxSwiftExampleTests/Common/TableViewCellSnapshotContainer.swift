...
final class TableViewCellSnapshotContainer<Cell: UITableViewCell>: UIView, UITableViewDataSource, UITableViewDelegate {
    ...
    init(width: CGFloat, configureCell: @escaping CellConfigurator, heightForWidth: HeightResolver? = nil, tableBackgroundColor: UIColor? = nil) {
        ...
        if let tableBackgroundColor = tableBackgroundColor {
